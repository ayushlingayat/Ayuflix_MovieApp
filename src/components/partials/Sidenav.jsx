...
const SideNav = () => {
  ...
  return (
    <>
       ...
       <span className="">AyuFlix</span> </h1>
       ...
       <nav className="flex flex-col text-zinc-400 text-xl gap-2">
        ...
        <Link to="/about" className="hover:bg-[#8b3b4f] hover:text-white duration-300 rounded-md p-3"><i className="ri-information-fill mr-2"></i>About AyuFlix</Link>
